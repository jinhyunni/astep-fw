...
--               /home/npl/AstroPix_9chip_2026TB_CERN/astep-fw/fw/astep24-3l/target-multiboard/vivado-run/astropix-cmodr2_3_CONFIG_SE.gen/sources_1/ip/xadc_astep/xadc_astep_sim_netlist.vhdl
-- Design      : xadc_astep
...
entity xadc_astepdrp_to_axi4stream is
  port (
  ...
  attribute ORIG_REF_NAME of xadc_astepdrp_to_axi4stream : entity is "drp_to_axi4stream";
end xadc_astepdrp_to_axi4stream;

architecture STRUCTURE of xadc_astepdrp_to_axi4stream is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity xadc_astep_xadc_core_drp is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 15 downto 0 );
    m_axis_tid : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
end xadc_astep_xadc_core_drp;

architecture STRUCTURE of xadc_astep_xadc_core_drp is
...
drp_to_axi4stream_inst: entity work.xadc_astepdrp_to_axi4stream
     port map (
      AR(0) => m_axis_reset,
      CHANNEL(4 downto 0) => \^channel_out\(4 downto 0),
      DO(15 downto 0) => do_C(15 downto 0),
...
end xadc_astep_axi_xadc;

architecture STRUCTURE of xadc_astep_axi_xadc is
...
begin
  ...
  alarm_out(1) <= \<const0>\;
  alarm_out(0) <= \<const0>\;
AXI_XADC_CORE_I: entity work.xadc_astep_xadc_core_drp
     port map (
...
entity xadc_astep is
  ...
  attribute NotValidForBitStream of xadc_astep : entity is true;
end xadc_astep;

architecture STRUCTURE of xadc_astep is
  signal NLW_inst_alarm_out_UNCONNECTED : STD_LOGIC_VECTOR ( 6 downto 0 );
begin
inst: entity work.xadc_astep_axi_xadc
     port map (
